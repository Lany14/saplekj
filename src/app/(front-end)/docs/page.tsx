import SidebarLink from "@/components/FrontEnd/Site/Docs/SidebarLink";
        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-3/4">
              <div className="blog-details blog-details-docs shadow-three rounded-sm bg-white px-8 py-11 dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
